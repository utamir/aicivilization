...
export function buildRoadPaths() {
    return ROADS.map((r) => {
...
export function Roads() {
    ...
    return (_jsx("group", { children: geoms.map((g, i) => (_jsx("mesh", { geometry: g, receiveShadow: true, children: _jsx("meshStandardMaterial", { color: "#262a31", roughness: 0.94, metalness: 0, polygonOffset: true, polygonOffsetFactor: -1 }) }, paths[i].key))) }));
}
