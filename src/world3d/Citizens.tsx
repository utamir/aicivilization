...
export function Citizens({ visualRef }: { visualRef: React.MutableRefObject<WorldVisual | null> }) {
  ...
  useFrame(() => {
    const mesh = bodyRef.current;
    if (!mesh || painted.current) return;
  ...
  return (
    <instancedMesh ref={bodyRef} args={[undefined, undefined, walkers.length]} frustumCulled={false}>
